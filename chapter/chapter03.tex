...
\begin{figure}[htbp]
	...
	\includegraphics[width=0.8\textwidth]{Fig/DFUAV_f31.png} 
...
\begin{figure}[htbp]
	...
	\FigureBicaption{\label{CVAE}（a）CVAE示意图；（b）VAE示意图}{(a) CVAE option}
\end{figure}
\begin{figure}[htbp]
	\centering
...
\begin{figure}[htbp]
	...
	\FigureBicaption{\label{CVAE2}（a）CVAE示意图；（b）VAE示意图}{(a) CVAE option}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{Fig/Maxwell_sin_metric.pdf}
	\FigureBicaption{\label{CVAE3}（a）CVAE示意图；（b）VAE示意图}{(a) CVAE option}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{Fig/Maxwell_timesteps_metrics.pdf}
	\FigureBicaption{\label{CVAE4}（a）CVAE示意图；（b）VAE示意图}{(a) CVAE option}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{Fig/giesekus_sin.pdf}
	\FigureBicaption{\label{CVAE5}（a）CVAE示意图；（b）VAE示意图}{(a) CVAE option}
\end{figure}
